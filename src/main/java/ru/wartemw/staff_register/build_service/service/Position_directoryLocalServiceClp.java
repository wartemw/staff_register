 ...
 * @generated
 */
public class Position_directoryLocalServiceClp
    ...
    public Position_directoryLocalServiceClp(
        ...
        _methodName19 = "createEntity";

        _methodParameterTypes19 = new String[] {  };

        _methodName20 = "addPosition_directory";

        _methodParameterTypes20 = new String[] { "java.lang.String", "boolean" };

        _methodName21 = "changePosition_directoryArchivalStatus";

        _methodParameterTypes21 = new String[] { "long" };

        _methodName22 = "getPosition_directoryList";

        _methodParameterTypes22 = new String[] {  };

        _methodName23 = "updatePosition_directory";
    ...
    public ru.wartemw.staff_register.build_service.model.Position_directory addPosition_directory(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(position_directory)
                    });
        } catch (Throwable t) {
        ...
        return (ru.wartemw.staff_register.build_service.model.Position_directory) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<ru.wartemw.staff_register.build_service.model.Position_directory> getPosition_directories(
        ...
        return (java.util.List<ru.wartemw.staff_register.build_service.model.Position_directory>) ClpSerializer.translateOutput(returnObj);
    }
